...
def generate_admin_override_code(
    email: str, admin_secret: str = "ADMIN_OVERRIDE_2025"
) -> str:
...
def generate_local_verification_link(
    email: str, base_url: str = "http://localhost:3000"
) -> str:
