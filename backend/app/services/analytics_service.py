...
class AnalyticsService:
    ...
    async def calculate_quality_score(
        ...
        workload_balance = balance_score(weekly_durations)

        # 5. Material Diversity: Shannon index on type distribution
        material_diversity = shannon_diversity(
        ...
        assessment_distribution = spread_score(due_weeks, total_weeks)
    ...
    async def calculate_weekly_quality(
        ...
        for week in range(1, total_weeks + 1):
            ...
            type_diversity = shannon_diversity(
            ...
            results.append(
                {
                    "week_number": week,
                    "star_rating": score_to_stars(week_score),
                    "has_content": True,
