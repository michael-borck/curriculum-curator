...
def upgrade() -> None:
    ...
    op.create_table('weekly_materials',
    ...
    op.create_table('local_learning_outcomes',
        ...
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.ForeignKeyConstraint(['material_id'], ['weekly_materials.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('wlo_ulo_mappings',
        ...
        sa.Column('ulo_id', GUID(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.ForeignKeyConstraint(['wlo_id'], ['weekly_learning_outcomes.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['ulo_id'], ['unit_learning_outcomes.id'], ondelete='CASCADE'),
