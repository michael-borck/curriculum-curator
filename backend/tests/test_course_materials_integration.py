...
class TestCourseCreation:
    ...
    def test_create_course(self, api_url, auth_headers, test_course_data):
        ...
        response = requests.post(
            f"{api_url}/courses", json=test_course_data, headers=auth_headers
        )
        assert response.status_code == 200
    ...
    def test_list_courses(self, api_url, auth_headers):
        ...
        response = requests.get(f"{api_url}/courses", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_get_course_details(self, api_url, auth_headers, test_course_data):
        ...
        # Get course details
        response = requests.get(f"{api_url}/courses/{course_id}", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_update_course(self, api_url, auth_headers, test_course_data):
        ...
        update_response = requests.put(
            f"{api_url}/courses/{course_id}", json=update_data, headers=auth_headers
        )
    ...
    def test_delete_course(self, api_url, auth_headers, test_course_data):
        ...
        delete_response = requests.delete(
            f"{api_url}/courses/{course_id}", headers=auth_headers
        )
...
class TestMaterialGeneration:
    ...
    def test_create_material(self, api_url, auth_headers, test_course_id):
        ...
        material_data = {
            ...
            "content": {
                ...
                "sections": [
                    {"title": "Overview", "content": "Testing overview content"}
                ],
            },
    ...
    def test_list_course_materials(self, api_url, auth_headers, test_course_id):
        ...
        response = requests.get(
            f"{api_url}/courses/{test_course_id}/materials", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    def test_get_material_details(self, api_url, auth_headers, test_course_id):
        ...
        response = requests.get(
            f"{api_url}/materials/{material_id}", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    def test_update_material(self, api_url, auth_headers, test_course_id):
        ...
        update_data = {
            ...
            "content": {
                "questions": [{"question": "What is testing?", "answer": "Validation"}]
            },
        }

        update_response = requests.put(
            f"{api_url}/materials/{material_id}", json=update_data, headers=auth_headers
        )
        assert update_response.status_code == 200
    ...
    def test_material_version_history(self, api_url, auth_headers, test_course_id):
        ...
        for i in range(2, 4):
            update_data = {"content": {"text": f"Version {i} content"}}
            requests.put(
        ...
        # Get version history
        response = requests.get(
            f"{api_url}/materials/{material_id}/versions", headers=auth_headers
        )
        assert response.status_code == 200
...
class TestLRDSystem:
    ...
    def test_list_course_lrds(self, api_url, auth_headers, test_course_id):
        ...
        # List LRDs
        response = requests.get(
            f"{api_url}/courses/{test_course_id}/lrds", headers=auth_headers
        )
        assert response.status_code == 200
    ...
    def test_update_lrd_status(self, api_url, auth_headers, test_course_id):
        ...
        update_response = requests.patch(
            f"{api_url}/lrds/{lrd_id}/status", json=status_update, headers=auth_headers
        )
