...
class TestMaterialCreation:
    ...
    @pytest.fixture
    def course_with_auth(self) -> tuple[dict | None, dict]:
    ...
    def test_create_lecture_material(self, course_with_auth):
        ...
        response = requests.post(
            f"{API_URL}/materials", json=material_data, headers=auth_headers
        )
...
class TestMaterialVersioning:
    ...
    @pytest.fixture
    def material_with_auth(self, course_with_auth) -> tuple[dict | None, dict]:
    ...
    def test_create_new_version(self, material_with_auth):
        ...
        response = requests.post(
            f"{API_URL}/materials", json=new_version_data, headers=auth_headers
        )
        ...
        original_response = requests.get(
            f"{API_URL}/materials/{material['id']}", headers=auth_headers
        )
    ...
    def test_version_history(self, material_with_auth):
        ...
        response = requests.get(
            f"{API_URL}/materials/{material['id']}/versions", headers=auth_headers
        )
    ...
    def test_compare_versions(self, material_with_auth):
        ...
        if v2_response.status_code in [200, 201]:
            ...
            compare_response = requests.get(
                ...
                params={"version1": material["id"], "version2": v2_id},
                headers=auth_headers,
            )
...
class TestMaterialSearch:
    ...
    def materials_with_auth(self, course_with_auth) -> tuple[bool, dict]:
        ...
        for material in materials:
            requests.post(f"{API_URL}/materials", json=material, headers=auth_headers)
    ...
    def test_search_by_type(self, materials_with_auth):
        ...
        # Search for lectures
        response = requests.get(
            f"{API_URL}/materials", params={"type": "LECTURE"}, headers=auth_headers
        )
    ...
    def test_search_by_title(self, materials_with_auth):
        ...
        response = requests.get(
            f"{API_URL}/materials", params={"search": "Python"}, headers=auth_headers
        )
    ...
    def test_get_latest_versions_only(self, materials_with_auth):
        ...
        # Get latest versions
        response = requests.get(
            f"{API_URL}/materials", params={"latest_only": True}, headers=auth_headers
        )
