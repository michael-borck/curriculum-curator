...
class TestLRDWorkflow:
    ...
    @pytest.fixture
    def test_course(self, auth_headers) -> dict | None:
        ...
        response = requests.post(
            f"{API_URL}/courses", json=course_data, headers=auth_headers
        )
    ...
    def test_create_lrd(self, auth_headers, test_course):
        ...
        lrd_data = {
            ...
            "content": {
                ...
                "assessment": {"type": "Quiz and Assignment", "weight": "20%"},
                "resources": [
        ...
        response = requests.post(f"{API_URL}/lrds", json=lrd_data, headers=auth_headers)
    ...
    def test_get_lrd(self, auth_headers, test_course):
        ...
        create_response = requests.post(
            f"{API_URL}/lrds", json=lrd_data, headers=auth_headers
        )
        ...
        if create_response.status_code in [200, 201]:
            ...
            # Get the LRD
            response = requests.get(f"{API_URL}/lrds/{lrd_id}", headers=auth_headers)
    ...
    def test_update_lrd(self, auth_headers, test_course):
        ...
        if create_response.status_code in [200, 201]:
            ...
            response = requests.patch(
                f"{API_URL}/lrds/{lrd_id}", json=update_data, headers=auth_headers
            )
    ...
    def test_lrd_approval_workflow(self, auth_headers, test_course):
        ...
        if create_response.status_code in [200, 201]:
            ...
            review_response = requests.post(
                f"{API_URL}/lrds/{lrd_id}/submit-review", headers=auth_headers
            )
            ...
            approve_response = requests.post(
                f"{API_URL}/lrds/{lrd_id}/approve", headers=auth_headers
            )
    ...
    def test_generate_tasks_from_lrd(self, auth_headers, test_course):
        ...
        if create_response.status_code in [200, 201]:
            ...
            # Generate tasks
            response = requests.post(
                f"{API_URL}/lrds/{lrd_id}/generate-tasks", headers=auth_headers
            )
    ...
    def test_list_course_lrds(self, auth_headers, test_course):
        ...
        response = requests.get(
            f"{API_URL}/courses/{test_course['id']}/lrds", headers=auth_headers
        )
        ...
        if v1_response.status_code in [200, 201]:
            ...
            if v2_response.status_code in [200, 201]:
                ...
                history_response = requests.get(
                    f"{API_URL}/lrds/{lrd_id}/versions", headers=auth_headers
                )
...
class TestTaskManagement:
    ...
    @pytest.fixture
    def lrd_with_auth(self, auth_headers, test_course) -> tuple[dict | None, dict]:
    ...
    def test_create_task_list(self, lrd_with_auth):
        ...
        response = requests.post(
            f"{API_URL}/task-lists", json=task_data, headers=auth_headers
        )
    ...
    def test_complete_all_tasks(self, lrd_with_auth):
        ...
        if create_response.status_code in [200, 201]:
            ...
            # Complete all tasks
            update_data = {"completed_tasks": 3, "status": "COMPLETE"}
...
class TestLRDConversations:
    ...
    @pytest.fixture
    def setup_data(self, auth_headers, test_course) -> tuple[dict | None, dict]:
    ...
    def test_save_conversation(self, setup_data):
        ...
        response = requests.post(
            f"{API_URL}/conversations", json=conversation_data, headers=auth_headers
        )
    ...
    def test_get_lrd_conversations(self, setup_data):
        ...
        response = requests.get(
            f"{API_URL}/lrds/{lrd['id']}/conversations", headers=auth_headers
        )
