...
def sample_config():
    ...
    config_dict = {
        ...
        "remediation": {
            "auto_fix": {
                "format_corrector": {"enabled": True, "aggressive": False},
                "sentence_splitter": {"enabled": True, "max_sentence_length": 20},
            },
            "rewrite": {"rephrasing_prompter": {"enabled": True, "llm_model_alias": "test_model"}},
        },
    }
...
class TestRemediationManager:
    ...
    async def test_remediate_with_specific_remediators(self, remediation_manager):
        ...
        config = {
            ...
            "options": {"auto_fix.sentence_splitter": {"max_sentence_length": 15}},
        }
