...
class TestLLMManager:
    ...
    def test_init(self, llm_manager):
        ...
        assert (
            llm_manager.config.llm.providers["test_provider"].api_key
            == TEST_CONFIG["llm"]["providers"]["test_provider"]["api_key"]
        )
        assert (
            llm_manager.config.llm.providers["test_provider"].default_model
            == TEST_CONFIG["llm"]["providers"]["test_provider"]["default_model"]
        )
    ...
    def test_calculate_cost(self, llm_manager):
        ...
        request = LLMRequest(prompt="Test prompt", provider="test_provider", model="test_model")
