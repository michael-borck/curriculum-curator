...
class TestStructureValidator:
    ...
    def validator(self):
        ...
        config = SimpleNamespace(
            min_sections=3, required_sections=["Introduction", "Content", "Summary"]
        )
...
class TestReadabilityValidator:
    ...
    def validator(self):
        ...
        config = SimpleNamespace(max_avg_sentence_length=15, min_flesch_reading_ease=70.0)
...
class TestSimilarityValidator:
    ...
    def validator(self):
        ...
        config = SimpleNamespace(threshold=0.85, model="all-MiniLM-L6-v2")
