                    ...
                    <div className='mt-2 flex items-center space-x-2'>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${
                          BLOOM_COLORS[outcome.bloom_level] ||
                  ...
                  {expandedWeeks.has(week.week_number) && (
                    <div className='px-4 py-3 border-t bg-gray-50'>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-3 text-sm'>
                        {week.pre_class_modules &&
                          week.pre_class_modules.length > 0 && (
                            <div>
                              <h5 className='font-medium text-gray-700 mb-1'>
                                Pre-class:
                              </h5>
                        ...
                        {week.in_class_activities &&
                          week.in_class_activities.length > 0 && (
                            <div>
                              <h5 className='font-medium text-gray-700 mb-1'>
                                In-class:
                              </h5>
                        ...
                        {week.post_class_tasks &&
                          week.post_class_tasks.length > 0 && (
                            <div>
                              <h5 className='font-medium text-gray-700 mb-1'>
                                Post-class:
                              </h5>
