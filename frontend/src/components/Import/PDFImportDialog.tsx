    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Import PDF Content</h2>
            <p className="text-gray-600 mt-1">Import course materials for {unitName}</p>
          </div>
          <button
            onClick={onClose}
          ...
          {importSuccess ? (
            <div className="py-12 text-center">
              ...
              <p className="text-gray-600">
                Course structure has been created from the PDF
              </p>
            </div>
          ) : (
            <>
              ...
              {!file && (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    Supports unit outlines, syllabi, lecture notes, and course materials
                  </p>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-medium">
                          {analysisResult.extracted_content.learning_outcomes_count}
                        </span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-medium">
                          {analysisResult.extracted_content.weekly_content_count}
                        </span>
                      </div>
                    </div>
                  </div>
