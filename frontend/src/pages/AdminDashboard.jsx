...
const AdminDashboard = () => {
  ...
  const users = [
    { id: 1, name: 'Dr. Jane Smith', email: 'j.smith@university.edu', role: 'Lecturer', courses: 4, status: 'active', lastActive: '2 hours ago' },
    { id: 2, name: 'Prof. John Doe', email: 'j.doe@university.edu', role: 'Lecturer', courses: 6, status: 'active', lastActive: '1 day ago' },
    { id: 3, name: 'Dr. Emily Chen', email: 'e.chen@university.edu', role: 'Lecturer', courses: 0, status: 'pending', lastActive: 'Never' },
    { id: 4, name: 'Dr. Michael Brown', email: 'm.brown@university.edu', role: 'Lecturer', courses: 3, status: 'active', lastActive: '5 hours ago' },
    { id: 5, name: 'Sarah Johnson', email: 's.johnson@university.edu', role: 'Admin', courses: 0, status: 'active', lastActive: 'Now' },
  ];
    ...
    <div className="p-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">Manage permissions and roles</p>
