...
import { 
  GraduationCap, Target, Shuffle, Brain, 
  Upload, Wand2, Puzzle, ArrowRight, 
  BookOpen, Users, Sparkles, CheckCircle 
} from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Choose from Traditional, Inquiry-Based, Project-Based, and more. Our AI adapts to your unique teaching style."
    },
    {
      icon: <Shuffle className="w-8 h-8 text-purple-600" />,
      title: "Multi-Scale Workflows",
      description: "Start from a full syllabus or focus on a single worksheet. Work at the scale that suits your needs."
    },
    {
      icon: <Brain className="w-8 h-8 text-purple-600" />,
      title: "AI Enhancement",
      description: "Intelligent suggestions for content improvement, alignment checks, and automated quality validation."
    },
    {
      icon: <Upload className="w-8 h-8 text-purple-600" />,
      title: "Import & Enhance",
      description: "Bring your existing materials. Support for DOCX, PPTX, Markdown, and more with smart remediation."
    },
    {
      icon: <Wand2 className="w-8 h-8 text-purple-600" />,
      title: "Dual Interface",
      description: "Wizard mode for guided creation or Expert mode for power users. Choose your comfort level."
    },
    {
      icon: <Puzzle className="w-8 h-8 text-purple-600" />,
      title: "Extensible Platform",
      description: "Plugin system for custom validators, remediation tools, and workflow extensions."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-gray-900">Curriculum Curator</span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-gray-600 hover:text-purple-600 transition">Features</a>
              <a href="#pedagogies" className="text-gray-600 hover:text-purple-600 transition">Pedagogies</a>
      ...
      <section className="bg-gradient-to-br from-purple-50 via-white to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
            AI-powered platform that aligns with your teaching philosophy. From high-level syllabi 
            to individual worksheets, create and curate content that resonates with your pedagogical approach.
          </p>
