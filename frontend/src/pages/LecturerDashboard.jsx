...
import {
  BookOpen, FileText, Users, TrendingUp,
  Clock, Award, Calendar, ArrowRight,
  Plus, Brain, Edit, Eye
} from 'lucide-react';
...
const LecturerDashboard = () => {
  ...
  const stats = [
    ...
    { label: 'Content Items', value: 127, icon: FileText, color: 'bg-green-500' },
    { label: "This Week's Tasks", value: 8, icon: Calendar, color: 'bg-yellow-500' },
  ...
  const recentActivity = [
    { type: 'create', content: 'Created worksheet for Week 3', time: '2 hours ago' },
    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Teaching Philosophy: <span className="font-semibold text-purple-600">Project-Based Learning</span>
        </p>
      </div>
