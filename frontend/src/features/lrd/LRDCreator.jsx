...
const LRDCreator = () => {
  ...
  // LRD Form State
  const [lrdData, setLrdData] = useState({
    course_id: courseId,
    version: '1.0',
    status: 'DRAFT',
    content: {
  ...
  // Save LRD
  const saveLRD = async (submitForReview = false) => {
    if (!validateForm()) {
      return;
    }
    ...
    try {
      ...
      const cleanedData = {
        ...
        content: {
          ...
          learning_outcomes: lrdData.content.learning_outcomes.filter(o => o.trim()),
          prerequisites: lrdData.content.prerequisites.filter(p => p.trim()),
          structure: {
            pre_class: {
              ...lrdData.content.structure.pre_class,
              activities: lrdData.content.structure.pre_class.activities.filter(a => a.trim()),
              materials: lrdData.content.structure.pre_class.materials.filter(m => m.trim())
            },
            in_class: {
              ...lrdData.content.structure.in_class,
              activities: lrdData.content.structure.in_class.activities.filter(a => a.trim()),
              materials: lrdData.content.structure.in_class.materials.filter(m => m.trim())
            },
            post_class: {
              ...lrdData.content.structure.post_class,
              activities: lrdData.content.structure.post_class.activities.filter(a => a.trim()),
              materials: lrdData.content.structure.post_class.materials.filter(m => m.trim())
            }
          },
          assessment: {
          ...
          resources: {
            ...
            recommended: lrdData.content.resources.recommended.filter(r => r.trim()),
            supplementary: lrdData.content.resources.supplementary.filter(r => r.trim())
          },
          technology_requirements: lrdData.content.technology_requirements.filter(t => t.trim())
        }
      };
      ...
      setErrors({ submit: error.response?.data?.detail || 'Failed to save LRD' });
    } finally {
      setSaving(false);
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setLrdData(prev => ({ ...prev, version: e.target.value }))}
          ...
          <div>
            ...
            <select
              value={lrdData.content.teaching_philosophy || course?.teaching_philosophy || 'TRADITIONAL'}
              onChange={(e) => setLrdData(prev => ({
                ...prev,
                content: { ...prev.content, teaching_philosophy: e.target.value }
              }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            >
        ...
        <div className="space-y-6">
            ...
            {lrdData.content.objectives.map((objective, index) => (
              <div key={index} className="flex mb-2">
                <input
                  type="text"
                  value={objective}
                  onChange={(e) => updateArrayItem('content.objectives', index, e.target.value)}
          ...
          <div>
            ...
            {lrdData.content.learning_outcomes.map((outcome, index) => (
              <div key={index} className="flex mb-2">
                <input
                  type="text"
                  value={outcome}
                  onChange={(e) => updateArrayItem('content.learning_outcomes', index, e.target.value)}
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="Enter learning outcome"
                />
                <button
                  onClick={() => removeArrayItem('content.learning_outcomes', index)}
                  className="ml-2 p-2 text-red-600 hover:bg-red-50 rounded-lg"
            ...
            {errors.learning_outcomes && (
              <p className="text-red-500 text-sm mt-1">{errors.learning_outcomes}</p>
            )}
          </div>
            ...
            {lrdData.content.prerequisites.map((prereq, index) => (
              <div key={index} className="flex mb-2">
                <input
                  type="text"
                  value={prereq}
                  onChange={(e) => updateArrayItem('content.prerequisites', index, e.target.value)}
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
        ...
        <div className="space-y-6">
          ...
          <div className="border-l-4 border-yellow-400 pl-4">
            ...
            <div className="mb-4">
              ...
              {lrdData.content.structure.pre_class.activities.map((activity, index) => (
                <div key={index} className="flex mb-2">
                  <input
                    type="text"
                    value={activity}
                    onChange={(e) => updateArrayItem('content.structure.pre_class.activities', index, e.target.value)}
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="Enter pre-class activity"
                  />
                  <button
                    onClick={() => removeArrayItem('content.structure.pre_class.activities', index)}
                    className="ml-2 p-2 text-red-600 hover:bg-red-50 rounded-lg"
                    disabled={lrdData.content.structure.pre_class.activities.length === 1}
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
              ...
              <button
                onClick={() => addArrayItem('content.structure.pre_class.activities')}
                className="mt-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 flex items-center"
              >
                <Plus className="h-4 w-4 mr-1" />
                Add Activity
          ...
          <div className="border-l-4 border-green-400 pl-4">
            ...
            <div className="mb-4">
              ...
              {lrdData.content.structure.in_class.activities.map((activity, index) => (
                <div key={index} className="flex mb-2">
                  <input
                    type="text"
                    value={activity}
                    onChange={(e) => updateArrayItem('content.structure.in_class.activities', index, e.target.value)}
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="Enter in-class activity"
                  />
                  <button
                    onClick={() => removeArrayItem('content.structure.in_class.activities', index)}
                    className="ml-2 p-2 text-red-600 hover:bg-red-50 rounded-lg"
                    disabled={lrdData.content.structure.in_class.activities.length === 1}
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
              ...
              <button
                onClick={() => addArrayItem('content.structure.in_class.activities')}
                className="mt-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 flex items-center"
              >
                <Plus className="h-4 w-4 mr-1" />
                Add Activity
          ...
          <div className="border-l-4 border-blue-400 pl-4">
            ...
            <div className="mb-4">
              ...
              {lrdData.content.structure.post_class.activities.map((activity, index) => (
                <div key={index} className="flex mb-2">
                  <input
                    type="text"
                    value={activity}
                    onChange={(e) => updateArrayItem('content.structure.post_class.activities', index, e.target.value)}
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="Enter post-class activity"
                  />
                  <button
                    onClick={() => removeArrayItem('content.structure.post_class.activities', index)}
                    className="ml-2 p-2 text-red-600 hover:bg-red-50 rounded-lg"
                    disabled={lrdData.content.structure.post_class.activities.length === 1}
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
              ...
              <button
                onClick={() => addArrayItem('content.structure.post_class.activities')}
                className="mt-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 flex items-center"
              >
                <Plus className="h-4 w-4 mr-1" />
                Add Activity
            ...
            {lrdData.content.resources.required.map((resource, index) => (
              <div key={index} className="flex mb-2">
                <input
                  type="text"
                  value={resource}
                  onChange={(e) => updateArrayItem('content.resources.required', index, e.target.value)}
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  placeholder="Enter required resource"
                />
                <button
                  onClick={() => removeArrayItem('content.resources.required', index)}
                  className="ml-2 p-2 text-red-600 hover:bg-red-50 rounded-lg"
