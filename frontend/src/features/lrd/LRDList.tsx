...
const LRDList = () => {
  ...
  const handleSubmitForReview = async (lrdId: string) => {
    try {
  ...
  const handleGenerateTasks = async (lrdId: string) => {
    try {
  ...
  const handleDelete = async (lrdId: string) => {
            ...
            >
              <div className='p-6'>
                ...
                <div className='space-y-3 mb-4'>
                  ...
                  {lrd.content?.objectives &&
                    lrd.content.objectives.length > 0 && (
                      <div>
