...
const teachingStyles = [
  {
    ...
    icon: BookOpen,
    color: 'bg-blue-500',
    description: 'Teacher-centered approach with lectures and structured content delivery',
    characteristics: [
      'Direct instruction',
      'Structured lessons',
      'Clear objectives',
  ...
  },
  {
    ...
    icon: Puzzle,
    color: 'bg-green-500',
    description: 'Students construct knowledge through experience and reflection',
    characteristics: [
      'Discovery learning',
      'Student-centered',
...
const TeachingStyle = () => {
  ...
  const [selectedStyle, setSelectedStyle] = useState(user?.teaching_philosophy || 'TRADITIONAL');
  ...
  const questions = [
    {
      ...
      options: [
        { value: 'TRADITIONAL', label: "Through structured lectures and presentations" },
        { value: 'CONSTRUCTIVIST', label: "By letting students explore and discover" },
        { value: 'FLIPPED_CLASSROOM', label: "Students read/watch at home, practice in class" },
        { value: 'INQUIRY_BASED', label: "Start with questions and investigations" }
      ]
    },
    {
      id: 1,
      ...
      options: [
        { value: 'COLLABORATIVE', label: "Students working in groups and teams" },
        { value: 'TRADITIONAL', label: "Teacher leading, students listening and taking notes" },
        { value: 'PROJECT_BASED', label: "Students working on long-term projects" },
        { value: 'EXPERIENTIAL', label: "Students learning through hands-on activities" }
      ]
    },
    {
      id: 2,
      ...
      options: [
        ...
        { value: 'PROJECT_BASED', label: "Project presentations and portfolios" },
        { value: 'PROBLEM_BASED', label: "Problem-solving demonstrations" },
        { value: 'CONSTRUCTIVIST', label: "Reflective journals and self-assessment" }
      ]
    },
    {
      id: 3,
      ...
      options: [
        { value: 'TRADITIONAL', label: "Expert and primary source of knowledge" },
        { value: 'CONSTRUCTIVIST', label: "Facilitator and guide" },
        { value: 'COLLABORATIVE', label: "Collaborator and co-learner" },
        { value: 'INQUIRY_BASED', label: "Question prompter and research advisor" }
      ]
    },
    {
      id: 4,
      ...
      options: [
        { value: 'FLIPPED_CLASSROOM', label: "Content at home, application in class" },
        { value: 'TRADITIONAL', label: "Lecture first, then practice" },
        { value: 'EXPERIENTIAL', label: "Experience first, then reflect and theorize" },
        { value: 'PROBLEM_BASED', label: "Present problem, then learn as needed" }
      ]
    }
  ];
  ...
  const calculateRecommendedStyle = () => {
    ...
    const recommended = Object.entries(styleCounts).find(([_, count]) => count === maxCount)?.[0];
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Teaching Style</h1>
        <p className="text-gray-600">
          Select your preferred teaching philosophy to customize content generation
        </p>
      </div>
        ...
        {selectedStyle && (
          <div className="flex items-center space-x-4">
            {(() => {
              ...
              return (
                <>
                  <div className={`p-3 rounded-lg ${style?.color || 'bg-gray-500'} text-white`}>
                    <Icon className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="text-lg font-medium">{style?.name || 'Mixed Approach'}</h3>
                    <p className="text-gray-600">{style?.description || 'A combination of teaching methods'}</p>
                  </div>
                </>
              );
            })()}
      ...
      <div className="mt-8 bg-blue-50 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-2">How Teaching Style Affects Content</h3>
        <p className="text-gray-700 mb-4">
          Your selected teaching philosophy influences how AI generates and structures educational content:
        </p>
