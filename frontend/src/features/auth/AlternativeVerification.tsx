...
const AlternativeVerification = ({ email, onClose }: AlternativeVerificationProps) => {
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-green-700 text-sm mt-1">
                Your @curtin.edu.au email is automatically verified! 
                You can log in immediately without a verification code.
              </p>
            </div>
          </div>
        </div>
        ...
        <>
          <div className="mb-6">
            <p className="text-gray-600 mb-4">
              Due to email restrictions, we offer alternative verification methods:
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Quick Verification</h3>
                    ...
                    {showCodes && (
                      <div className="mt-3 p-3 bg-purple-50 rounded-lg text-sm">
                        ...
                        <ol className="list-decimal list-inside space-y-1 text-purple-800">
                          <li>Run: <code className="bg-white px-1 rounded">./generate_verification_codes.py {email}</code></li>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Manual Approval</h3>
                    <p className="text-sm text-gray-600 mt-1">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-amber-700 text-sm mt-1">
                  University email systems may block verification emails from external services. 
                  Please use one of the alternative methods above.
                </p>
              </div>
            </div>
          </div>
