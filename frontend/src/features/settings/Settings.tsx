              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Use the institution's configured LLM provider</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Use your own OpenAI API key</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Use your own Anthropic API key</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Use your own Google Gemini API key</p>
                      </div>
                    </label>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {llmSettings.provider === 'gemini' && (
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setLlmSettings({ ...llmSettings, geminiApiKey: e.target.value })}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                          placeholder="AIza..."
                        />
                        <p className="text-sm text-gray-600 mt-1">
                    ...
                    <div className="mt-4">
                      ...
                      <select
                        ...
                        onChange={(e) => setLlmSettings({ ...llmSettings, modelPreference: e.target.value })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                      >
                ...
                {llmSettings.provider === 'system' && (
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h3 className="font-medium text-blue-900 mb-2">System Default Provider</h3>
                    <p className="text-sm text-blue-800">
                      You are using the institution's configured LLM provider. Contact your administrator
                      for details about the current provider and model being used.
                    </p>
                  </div>
                )}
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        if (llmSettings.provider === 'anthropic' && llmSettings.anthropicApiKey) {
                          llmConfig.anthropic_api_key = llmSettings.anthropicApiKey;
                        }
                        if (llmSettings.provider === 'gemini' && llmSettings.geminiApiKey) {
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <label className="cursor-pointer">
                      ...
                      <div className={`p-4 border-2 rounded-lg text-center ${
                        preferences.theme === 'light' ? 'border-blue-500' : 'border-gray-200'
                      }`}>
                    ...
                    <label className="cursor-pointer">
                      ...
                      />
                      <div className={`p-4 border-2 rounded-lg text-center ${
                        preferences.theme === 'dark' ? 'border-blue-500' : 'border-gray-200'
                      }`}>
                    ...
                    <label className="cursor-pointer">
                      ...
                      />
                      <div className={`p-4 border-2 rounded-lg text-center ${
                        preferences.theme === 'auto' ? 'border-blue-500' : 'border-gray-200'
                      }`}>
