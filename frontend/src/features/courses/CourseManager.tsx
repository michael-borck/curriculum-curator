    ...
    <div className='p-6'>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className='text-gray-600 mt-2'>Manage your courses and learning resources</p>
        </div>
        <button
                ...
                <div className="flex justify-between items-center">
                  <div className="flex space-x-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/courses/${course.id}/lrds`);
                      }}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewCourse({ ...newCourse, teaching_philosophy: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
