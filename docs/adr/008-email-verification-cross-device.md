...
After implementing basic authentication (ADR-007), we identified the need for email verification to:
...
- Supersedes the basic authentication approach in ADR-007
- Complements the no-JavaScript decision (ADR-006) by keeping verification server-side
