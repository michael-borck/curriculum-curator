...
3. **Leverage existing infrastructure** — LiteLLM already supports Ollama via `ollama/model_name` format (ADR-014)
...
- [ADR-014: LiteLLM Unified LLM Abstraction](014-litellm-unified-llm-abstraction.md) — Ollama support via `ollama/model_name`
- [ADR-020: AI-Optional User Empowerment](020-ai-optional-user-empowerment.md) — AI assists, never gates
- [ADR-024: LOCAL_MODE and PyInstaller Compatibility](024-local-mode-pyinstaller-compatibility.md) — Privacy-first local deployment
