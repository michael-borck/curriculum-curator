...
With email verification in place (ADR-008), we can now implement self-service password reset functionality. This addresses a critical operational need:
...
- Builds on email service from ADR-008
- Maintains no-JavaScript approach (ADR-006)
- Complements simple authentication (ADR-007)
