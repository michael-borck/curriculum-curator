...
Superseded by [ADR-016: React + TypeScript Frontend](016-react-typescript-frontend.md)

**Historical Note**: This decision was later superseded by ADR-012 (NiceGUI migration, never implemented), then by ADR-016 (React + TypeScript, current production stack). Preserved for historical context.
...
- [ADR-003](003-plugin-architecture.md) - Plugin architecture adapted for FastHTML