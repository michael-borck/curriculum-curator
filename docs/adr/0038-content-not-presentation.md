# ADR-0038: Content Curation, Not Presentation Design
...
- **No media library**: Users managing many images across materials must organise them externally. Acceptable for the single-user desktop target (ADR-0037).
...
- The approach aligns with ADR-0037 (local-first): images stored on-disk with content, no cloud media hosting.
...
- [ADR-0037: Privacy-First, BYOK Architecture](0037-privacy-first-byok-architecture.md)
