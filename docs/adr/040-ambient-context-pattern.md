# 040. Ambient Context — Best Guess + Human Override
...
- [ADR-020: AI-Optional User Empowerment](020-ai-optional-user-empowerment.md) — features degrade gracefully without AI, same principle applies to context
- [ADR-004: Teaching Philosophy System](004-teaching-philosophy-system.md) — earlier instance of the same pattern (persisted default with override)
