...
- Each framework as a plugin (per ADR-0003) with its own schema and UI
...
- [ADR-0020: AI-Optional User Empowerment](0020-ai-optional-user-empowerment.md) — Mappings are manual, not AI-generated
- [ADR-0018: Workflow Flexibility](0018-workflow-flexibility-philosophy.md) — Mapping panels are optional, not enforced
