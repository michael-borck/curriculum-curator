...
## Related Decisions
- ADR-006: Pure FastHTML Without JavaScript (simplifies auth flow)
- ADR-002: Validation and Remediation Design (affects user permissions model)
- ADR-008: Email Verification with Cross-Device Support (extends this design)
- ADR-009: Self-Service Password Reset (implements Phase 1 enhancement)