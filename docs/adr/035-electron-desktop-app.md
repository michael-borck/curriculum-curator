...
- Already works (Docker Compose with Ollama sidecar, ADR-025/0026)
...
- [ADR-025: Ollama Docker Sidecar for Local AI](025-ollama-docker-sidecar-local-ai.md)
- [ADR-026: Single-Container Deployment](026-single-container-deployment.md)
