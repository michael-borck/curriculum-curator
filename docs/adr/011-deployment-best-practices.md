...
While Curriculum Curator has built-in security measures (ADR-010), deploying any web application requires additional considerations at the infrastructure level. As an open source project, we need to provide clear guidance for secure production deployments.
...
- Implements security from ADR-010
- Supports authentication system (ADR-007, 0008, 0009)
